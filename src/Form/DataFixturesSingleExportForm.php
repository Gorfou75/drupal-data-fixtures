 ...
 */
class DataFixturesSingleExportForm extends FormBase {
  ...
  /**
   * DataFixturesSingleExportForm constructor.
   *
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    foreach ($this->dataFixturesTypeManager->getDefinitions() as $plugin_id => $plugin_definition) {
      $options[$plugin_id] = $plugin_definition['label'] . ' (' . $plugin_definition['type'] . ')';
    }
